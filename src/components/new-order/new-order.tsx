...
import { orderSchema, OrderFormValues } from "@/zod/orders/neworder.shema";
...
import { ItNewOrdersColumns } from "@/features/orders/newordercolum";
const NewOrder = () => {
  ...
  const { mutate: createOrder, data: createOrderData } = $api.useMutation(
    "post",
    "/orders",
    {
      onSuccess: () => {
    ...
    <div>
      <div className="mx-auto mt-6 w-full max-w-xl">
        <Stepper
          ...
          steps={[{ title: "تفاصيل الطلب" }, { title: "ارسال الطلب" }]}
        />
      </div>
