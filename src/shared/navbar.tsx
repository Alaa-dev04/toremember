      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-4">
          <div className="flex flex-col text-left">
            ...
            <span className="text-xs text-[#A0A0A0] sm:text-base">user </span>
          </div>
          <div className="bg-primary flex size-10 items-center justify-center rounded-full text-base font-bold text-[#F9F9F9] sm:size-12">ai </div>
        </div>
      </div>
    </header>
  );
